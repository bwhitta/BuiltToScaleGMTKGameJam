...
public class CameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log($"camera orthographicSize: {Camera.main.orthographicSize}, camera is orthographic: {Camera.main.orthographic}, offsetPercent: {offsetPercent}, targetPosition: {targetPosition}, cameraTargetX: {cameraTargetX}, cameraTargetY: {cameraTargetY}");
